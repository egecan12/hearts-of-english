...
const YurtdisiEgitim = () => {
  ...
  return (
    <>
      <SEO 
        title="Yurtdışı Eğitim | Heart of English | Yurtdışı Eğitim Danışmanlığı"
        description="Heart of English ile yurtdışı eğitim fırsatları. ABD, İngiltere, Almanya, Fransa ve Letonya'da eğitim imkanları için danışmanlık hizmetleri."
        keywords="yurtdışı eğitim, yurtdışında üniversite, ABD'de eğitim, İngiltere'de eğitim, Almanya'da eğitim, yurtdışı eğitim danışmanlığı"
        canonicalUrl="/yurtdisi-egitim"
      />
      <Box sx={{ py: 6 }}>
