...
const Home = () => {
  ...
  return (
    <>
      <SEO 
        title="Heart of English | Eskişehir'in Kalbinde İngilizce Eğitimi"
        description="Heart of English ile VIP konseptli İngilizce eğitimi ve yurtdışı eğitim danışmanlığı. 20 yılı aşkın tecrübe ile Eskişehir'in merkezinde hizmetinizdeyiz."
        keywords="İngilizce kursu, Eskişehir dil kursu, İngilizce eğitimi, TOEFL, IELTS, yurtdışı eğitim"
        canonicalUrl="/"
      />
      <Box>
        {/* Hero Section */}
